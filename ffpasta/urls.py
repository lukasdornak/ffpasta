...
urlpatterns = [
    ...
    path('registrace/', views.RegistrationView.as_view()),
    path('overeni-emailu/<int:id>/<slug:token>/', views.verify_email),
    path('nove-overeni-emailu/<int:id>/', views.resend_email_verification_token),
    path('overte-svou-adresu/', views.email_verification_required),
    path('zakaznik/', views.CustomerDetailView.as_view()),
    path('nastaveni/', views.CustomerUpdateView.as_view()),
